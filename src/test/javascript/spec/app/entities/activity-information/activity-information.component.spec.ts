...
import { ActivityInformationComponent } from 'app/entities/activity-information/activity-information.component';
...
describe('Component Tests', () => {
  describe('ActivityInformation Management Component', () => {
    let comp: ActivityInformationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ActivityInformationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ActivityInformation(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.activityInformations && comp.activityInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
