...
import com.fu.epayment.repository.CategoryRepository;
...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDescrpition()).isEqualTo(DEFAULT_DESCRPITION);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].descrpition").value(hasItem(DEFAULT_DESCRPITION.toString())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.descrpition").value(DEFAULT_DESCRPITION.toString()));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getDescrpition()).isEqualTo(UPDATED_DESCRPITION);
    }
