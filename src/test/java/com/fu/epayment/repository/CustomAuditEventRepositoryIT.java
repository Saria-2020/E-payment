...
import com.fu.epayment.config.audit.AuditEventConverter;
import com.fu.epayment.domain.PersistentAuditEvent;
...
import static com.fu.epayment.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
