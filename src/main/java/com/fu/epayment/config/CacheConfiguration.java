package com.fu.epayment.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.fu.epayment.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.fu.epayment.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.fu.epayment.domain.Customer.class.getName() + ".accounts");
            ...
            createCache(cm, com.fu.epayment.domain.Customer.class.getName() + ".transactions");
