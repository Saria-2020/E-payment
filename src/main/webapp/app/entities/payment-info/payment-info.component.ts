...
export class PaymentInfoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.paymentInfoService
      ...
      .subscribe(
        (res: HttpResponse<IPaymentInfo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPaymentInfos(): void {
    this.eventSubscriber = this.eventManager.subscribe('paymentInfoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPaymentInfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
